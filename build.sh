#!/bin/sh
set -e -o pipefail
CFLAGS="-target x86_64-apple-xros1.0-simulator -Os -g -Wall -fmodules -fobjc-arc -Ithird_party/x264/out_visionos/include"
...
xcrun -sdk xrsimulator clang++ $CFLAGS -shared -o libvisionos_stereo_screenshots.dylib -fvisibility=hidden \
	...
	third_party/x264/out_visionos/lib/libx264.a third_party/alvr/target/x86_64-apple-ios/debug/libalvr_server.a \
